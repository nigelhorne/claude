...
- Identify and comment out any paths that cannot be executed and show them for me to review.
- Add tests to function.t, unit.t, integration.t and edge\_cases.t to test the new code written while those files and t/extended\_tests.t were created
